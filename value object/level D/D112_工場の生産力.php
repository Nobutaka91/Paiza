<?php
    ...
    $ptroductionCount = $operatingInfo->toProductionCount();
    echo $ptroductionCount->value();
    ...
    final class OperatingInfo
    {
        ...
        public function toProductionCount() : ProductionCount
        {
            return new ProductionCount($this->itemNumPer1Hour->value() * $this->operatingHours->value());
        }
        
    }
    
    final class ProductionCount
    {
        private $value;
