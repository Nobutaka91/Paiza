...
// 受験者それぞれの各科目の点数が入力されるので、何人2段階選抜を通過できるかを求める。
    ...
    foreach($scoreDataList as $scoreData ) {
        ...
        $successfulCandidatesNum = new SuccessfulCandidatesList($totalScore, $course, $scienceSubjects, $humanitiesSubjects);
        $outputList += $successfulCandidatesNum->classifySuccessfulCandidates();
    }

    echo $outputList;

    class SuccessfulCandidatesList
    {
