###########################################
# continueはforeach,for,whileで使用できるが、
# ユーザー定義関数内では使用できない
###########################################
...
class FoodList
{
    ...
    public function __construct($commonFoodList, $recipeFoodList, $possessFoodList, $possessFoodName)
    {
    ...
    public function verifyCookableFoodNum()
    {
