<?php
    ...
    {
         public function calcurateTotalWage();
    }
    ...
    class HourlyWage implements Calcuration
    {
    ...
    class TotalWageChecker implements Calcuration
    {
        private $workHour;
        private $hourlyWage;
        ...
        public function calcurateTotalWage()
        {
            ...
            for($j = $this->workHour->begin(); $j < $this->workHour->finish(); $j++) {
                $totalWage[] = $this->hourlyWage->calcurateTotalWage()[$j];        
            }
